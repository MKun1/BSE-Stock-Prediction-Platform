...
document.getElementById('stock-form').addEventListener('submit', function(event) {
  ...
  'SAIL'         // Steel Authority of India (SAIL)
    ...
    if (!validStockCodes.includes(stockSymbolInput.value.toUpperCase())) {
        ...
        loadingContainer.style.display = 'block'; // Show spinner and loading text

        // Simulate backend interaction (e.g., API call)
        setTimeout(() => {
            loadingContainer.style.display = 'none'; // Hide spinner after data is fetched
